...
public class HeapPage implements Page {
    ...
    */
    ...
    public Iterator<Tuple> iterator() {
        return new HeapPageIterator(this.tuples, this.header);
    }
    ...
    public class HeapPageIterator implements Iterator<Tuple> {
		...
		public HeapPageIterator(Tuple tuples[], byte header[]) {
    		tupleL = tuples;
    		headerL = header;
    	}
		...
		public boolean hasNext() {
			if (index == tupleL.length) {
				return false;
			}
			for (int i = index; i < tupleL.length; i++) {
				if (isSlotUsed(i)) {
					return true;
				}
			}
